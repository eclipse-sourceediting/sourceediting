...
public class ContentAssistRequest {
	 ...
	 */
	public ContentAssistRequest(IJSONNode node, IJSONNode parent,
	...
	public int getStartOffset() {
		if ((getDocumentRegion() != null) && (getRegion() != null)) {
			return ((ITextRegionCollection) getDocumentRegion())
					.getStartOffset(getRegion());
		}
		return -1;
	}
	...
	public boolean shouldSeparate() {
		 ...
		 * Boolean
		 * (caSettings.getAttribute(PreferenceNames.SEPARATE).equals(PreferenceNames
		 * .TRUE)); } } return separate.booleanValue();
		 */
		return false;
	}
