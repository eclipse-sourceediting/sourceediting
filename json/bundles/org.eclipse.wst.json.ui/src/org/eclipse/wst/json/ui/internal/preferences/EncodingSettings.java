 ...
 *     Angelo Zerr <angelo.zerr@gmail.com> - copied from org.eclipse.wst.xml.ui.internal.preferences.EncodingSettings
...
public class EncodingSettings extends Composite {
	...
	private static String ENCODING_LABEL = JSONUIMessages.EncodingSettings_1;

	private static String IANA_LABEL = JSONUIMessages.EncodingSettings_0;
	...
	private void fillCombo() {
		try {
			...
			// JSONEncodingPlugin.getPlugin().getMsgLogger().write(e.toString());
			// JSONEncodingPlugin.getPlugin().getMsgLogger().writeCurrentThread();
