...
import org.eclipse.wst.json.bower.ui.internal.BowerUIPlugin;
 ...
 * @author amywu
 */
public class BowerEditorPluginImageHelper {
	private static BowerEditorPluginImageHelper instance = null;
	 ...
	 */
	public synchronized static BowerEditorPluginImageHelper getInstance() {
		if (instance == null) {
			instance = new BowerEditorPluginImageHelper();
		}
		return instance;
	}
	...
	private final String PLUGINID = BowerUIPlugin.PLUGIN_ID;
	...
	private ImageRegistry getImageRegistry() {
		return BowerUIPlugin.getDefault().getImageRegistry();
	}
}
