...
class StaticWebProjectWizardBasePage extends WTPWizardPage
{
	 ...
	 *            java.lang.String
	 */
	public StaticWebProjectWizardBasePage(
			StaticWebProjectCreationDataModel dataModel, String pageName)
	{
	...
	{
		return new String[] { StaticWebProjectCreationDataModel.PROJECT_NAME,
				StaticWebProjectCreationDataModel.PROJECT_LOCATION};
	}
