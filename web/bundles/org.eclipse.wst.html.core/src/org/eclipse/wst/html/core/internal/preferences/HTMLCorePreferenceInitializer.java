...
public class HTMLCorePreferenceInitializer extends AbstractPreferenceInitializer {
	...
	private void initializeValidationPreferences(IEclipsePreferences node) {
		// Ignored Element names
		node.putBoolean(HTMLCorePreferenceNames.IGNORE_ELEMENT_NAMES, HTMLCorePreferenceNames.IGNORE_ELEMENT_NAMES_DEFAULT);
		node.put(HTMLCorePreferenceNames.ELEMENT_NAMES_TO_IGNORE, HTMLCorePreferenceNames.ELEMENT_NAMES_TO_IGNORE_DEFAULT);
