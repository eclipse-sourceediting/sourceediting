...
public interface HTML40Namespace {
	...
	public static final String ATTR_VALUE_LOWER_ALPHA = "a"; // LI //$NON-NLS-1$ }} //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$
	public static final String ATTR_VALUE_UPPER_ALPHA = "A"; // LI //$NON-NLS-1$ }} //$NON-NLS-1$
	public static final String ATTR_VALUE_LOWER_ROMAN = "i"; // LI //$NON-NLS-1$ }} //$NON-NLS-1$ //$NON-NLS-1$
	public static final String ATTR_VALUE_UPPER_ROMAN = "I"; // LI //$NON-NLS-1$ }} //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$ //$NON-NLS-1$
