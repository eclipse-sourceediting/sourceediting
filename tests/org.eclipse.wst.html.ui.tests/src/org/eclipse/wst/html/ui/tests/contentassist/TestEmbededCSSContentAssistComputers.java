...
public class TestEmbededCSSContentAssistComputers extends TestCase {
	...
	public static Test suite() {
		TestSuite ts = new TestSuite(TestEmbededCSSContentAssistComputers.class, "Test Embeded CSS Content Assist Computers");
		return new TestEmbededCSSContentAssistComputersSetup(ts);
	}
