 ...
 */
/*
 * $Id: ElemPI.java,v 1.3 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class ElemPI extends ElemTemplateElement {
	...
	public void compose(StylesheetRoot sroot) throws TransformerException {
		...
		if (null != m_name_atv)
			m_name_atv.fixupVariables(vnames, sroot.getComposeState()
					.getGlobalsSize());
	}
	...
	public void execute(TransformerImpl transformer)
		...
		try {
			transformer.getResultTreeHandler().processingInstruction(piName,
					data);
