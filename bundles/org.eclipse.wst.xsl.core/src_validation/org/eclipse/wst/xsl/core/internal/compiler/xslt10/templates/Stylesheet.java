 ...
 */
/*
 * $Id: Stylesheet.java,v 1.2 2008/03/28 02:38:15 dacarver Exp $
 */
 ...
 */
public class Stylesheet extends ElemTemplateElement implements
		java.io.Serializable /* , Document */
{
	...
	/**
	 * Get an "exclude-result-prefix" property. The designation of a namespace
	 * as an excluded namespace is effective within the subtree of the
	 * stylesheet rooted at the element bearing the exclude-result-prefixes or
	 * xsl:exclude-result-prefixes attribute; a subtree rooted at an
	 * xsl:stylesheet element does not include any stylesheets imported or
	 * included by children of that xsl:stylesheet element.
	...
	public int getExcludeResultPrefixCount() {
		return (null != m_ExcludeResultPrefixs) ? m_ExcludeResultPrefixs.size()
				: 0;
	}
	...
	public boolean containsExcludeResultPrefix(String prefix, String uri) {
		...
		for (int i = 0; i < m_ExcludeResultPrefixs.size(); i++) {
			if (uri.equals(getNamespaceForPrefix(m_ExcludeResultPrefixs
					.elementAt(i))))
				return true;
		}
	...
	public void setVersion(String v) {
		m_Version = v;
		m_isCompatibleMode = (Double.valueOf(v).doubleValue() > org.apache.xml.utils.Constants.XSLTVERSUPPORTED);
	}
	 ...
	 * @return null if not found, otherwise a DecimalFormatProperties object,
	 *         from which you can get a DecimalFormatSymbols object.
	 */
	...
	public DecimalFormatProperties getDecimalFormat(int i)
		...
		return (DecimalFormatProperties) m_DecimalFormatDeclarations
				.elementAt(i);
	}
	...
	public int getDecimalFormatCount() {
		return (null != m_DecimalFormatDeclarations) ? m_DecimalFormatDeclarations
				.size()
				: 0;
	}
	...
	public int getStripSpaceCount() {
		return (null != m_whitespaceStrippingElements) ? m_whitespaceStrippingElements
				.size()
				: 0;
	}
	...
	public int getPreserveSpaceCount() {
		return (null != m_whitespacePreservingElements) ? m_whitespacePreservingElements
				.size()
				: 0;
	}

	/**
	 * The "xsl:output" properties. This is a vector of OutputProperties
	 * objects.
	 * 
	 * @serial
	 */
	 ...
	 * 
	 * @param v
	 *            non-null reference to the OutputProperties object to be added
	 *            to the collection.
	 */
	 ...
	 * instantiate it, and replace the original with the compiled instance.
	...
	protected void callChildVisitors(XSLTVisitor visitor, boolean callAttrs) {
		...
		if (null != m_NonXslTopLevel) {
			...
			while (elements.hasMoreElements()) {
				ElemTemplateElement elem = (ElemTemplateElement) elements
						.nextElement();
