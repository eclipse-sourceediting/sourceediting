 ...
 */
/*
 * $Id: Constants.java,v 1.3 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class Constants extends org.apache.xml.utils.Constants {
	...
	public static final int ELEMNAME_UNDEFINED = -1,
			...
			ELEMNAME_VARIABLE = 73, ELEMNAME_MESSAGE = 75,
			ELEMNAME_LOCALE = 76, ELEMNAME_LITERALRESULT = 77,
			ELEMNAME_TEXTLITERALRESULT = 78, ELEMNAME_EXTENSIONCALL = 79,
			ELEMNAME_EXTENSIONDECL = 85, ELEMNAME_EXTENSIONSCRIPT = 86,
			ELEMNAME_OUTPUT = 80, ELEMNAME_COMPONENT = 81,
			ELEMNAME_SCRIPT = 82;
	...
	public static final String ELEMNAME_ANCHOR_STRING = "anchor",
			...
			ELEMNAME_ELEMENT_STRING = "element", // pattern-by-example
													// support
	...
	public static final String ATTRNAME_AMOUNT = "amount",
			...
			ATTRNAME_XMLNS = "xmlns:", // namespace declaration prefix -- NOT
	...
	public static final int TATTRNAME_OUTPUT_METHOD = 1, TATTRNAME_AMOUNT = 2,
			...
			TATTRNAME_MATCH = 36, TATTRNAME_METHOD = 37, TATTRNAME_MODE = 38,
			TATTRNAME_NAME = 39, TATTRNAME_NAMESPACE = 40,
	 ...
	 * </li>
	 * ATTRVAL_OUTPUT_METHOD_TEXT: Use a Text formatter to produce the output
	 * document. Generally the right choice if your stylesheet wants to take
	 * over _all_ the details of formatting, most often when producing something
	 * that isn't an XML or HTML document.</li>
	 * </ul>
	 */
