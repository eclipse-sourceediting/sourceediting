 ...
 */
/*
 * $Id: DecimalFormatProperties.java,v 1.2 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class DecimalFormatProperties extends ElemTemplateElement {
	 ...
	 * the interpretation of a format pattern used by the format-number
	 * function. If there is a name attribute, then the element declares a named
	 ...
	 * the same value for all attributes (taking into account any default
	 * values).
	 * </p>
	 * <p>
	 * The other attributes on xsl:decimal-format correspond to the methods on
	 * the JDK 1.1 DecimalFormatSymbols class. For each get/set method pair
	 * there is an attribute defined for the xsl:decimal-format element.
	 * </p>
	 * 
	 * @return the decimal format Symbols for this element.
	 */
	 ...
	 * character used as a grouping (e.g. thousands) separator; the default
	 * value is the comma character (,).
	 * 
	 * @param gs
	...
	/**
	 * Set the "minus-sign" attribute. minus-sign specifies the character used
	 * as the default minus sign; the default value is the hyphen-minus
	 * character (-, #x2D).
	 * 
	 * @param v
	...
	/**
	 * Get the "minus-sign" attribute. minus-sign specifies the character used
	 * as the default minus sign; the default value is the hyphen-minus
	 * character (-, #x2D).
	 * 
	...
	/**
	 * Set the "NaN" attribute. NaN specifies the string used to represent the
	...
	/**
	 * Get the "NaN" attribute. NaN specifies the string used to represent the
	 * NaN value; the default value is the string NaN.
	 * 
	...
	/**
	 * Set the "per-mille" attribute. per-mille specifies the character used as
	 * a per mille sign; the default value is the Unicode per-mille character
	 * (#x2030).
	 * 
	 * @param v
	...
	/**
	 * Get the "per-mille" attribute. per-mille specifies the character used as
	 * a per mille sign; the default value is the Unicode per-mille character
	 * (#x2030).
	 * 
	...
	/**
	 * Set the "zero-digit" attribute. zero-digit specifies the character used
	 * as the digit zero; the default value is the digit zero (0).
	 * 
	 * @param v
	...
	/**
	 * Get the "zero-digit" attribute. zero-digit specifies the character used
	 * as the digit zero; the default value is the digit zero (0).
	 * 
	 ...
	 * character used to separate positive and negative sub patterns in a
	...
	/**
	 * This function is called to recompose() all of the decimal format
	 * properties elements.
	 * 
	 * @param root
	 *            Stylesheet root
