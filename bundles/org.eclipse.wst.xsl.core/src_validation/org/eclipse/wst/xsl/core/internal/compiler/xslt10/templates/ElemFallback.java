 ...
 */
/*
 * $Id: ElemFallback.java,v 1.2 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class ElemFallback extends ElemTemplateElement {
	 ...
	 * with the XSLT 1.0 Recommendation, chapter 15, "Normally, instantiating an
	 * xsl:fallback element does nothing."
	 * 
	 * @param transformer
	 ...
	 * instruction element has one or more xsl:fallback children, then the
	 * content of each of the xsl:fallback children must be instantiated in
	 * sequence; otherwise, an error must be signaled. The content of an
	...
	public void executeFallback(TransformerImpl transformer)
		...
		if (Constants.ELEMNAME_EXTENSIONCALL == parentElemType
			...
			// Should never happen
			System.out
					.println("Error!  parent of xsl:fallback must be an extension or unknown element!");
		}
	}
}
