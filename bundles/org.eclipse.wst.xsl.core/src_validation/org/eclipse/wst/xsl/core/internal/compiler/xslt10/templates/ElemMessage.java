 ...
 */
/*
 * $Id: ElemMessage.java,v 1.3 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class ElemMessage extends ElemTemplateElement {
	 ...
	 * should terminate processing after sending the message. The default value
	 * is no.
	 * 
	 * @serial
	 */
	...
	/**
	 * Send a message to diagnostics. The xsl:message instruction sends a
	 * message in a way that is dependent on the XSLT transformer. The content
	 * of the xsl:message instruction is a template. The xsl:message is
	 * instantiated by instantiating the content to create an XML fragment. This
