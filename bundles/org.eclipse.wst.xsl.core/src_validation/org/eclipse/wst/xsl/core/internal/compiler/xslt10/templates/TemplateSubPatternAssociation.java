 ...
 */
/*
 * $Id: TemplateSubPatternAssociation.java,v 1.2 2008/03/28 02:38:15 dacarver Exp $
 */
...
class TemplateSubPatternAssociation implements Serializable, Cloneable {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		TemplateSubPatternAssociation tspa = (TemplateSubPatternAssociation) super
				.clone();
	...
	private boolean matchModes(QName m1, QName m2) {
		return (((null == m1) && (null == m2)) || ((null != m1) && (null != m2) && m1
				.equals(m2)));
	}
	 ...
	 * less in priority to this association, and, if equal priority, should
	 * occur before this template in document order.
	 * 
	 * @param mp
