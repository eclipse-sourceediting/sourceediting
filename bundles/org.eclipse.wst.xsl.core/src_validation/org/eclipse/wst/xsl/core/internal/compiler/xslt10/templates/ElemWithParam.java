 ...
 */
/*
 * $Id: ElemWithParam.java,v 1.4 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class ElemWithParam extends ElemTemplateElement {
	 ...
	 * name attribute is a QName, which is expanded as described in [2.4
	 * Qualified Names].
	 * 
	 * @serial
	 */
	...
	public void compose(StylesheetRoot sroot) throws TransformerException {
		...
		if (null != m_selectPattern)
			m_selectPattern.fixupVariables(vnames, sroot.getComposeState()
					.getGlobalsSize());
