 ...
 */
/*
 * $Id: ElemTextLiteral.java,v 1.2 2008/03/28 02:38:15 dacarver Exp $
 */
...
public class ElemTextLiteral extends ElemTemplateElement {
	 ...
	 * 
	 * @param v
	 *            Boolean flag indicating whether or not space should be
	 *            preserved
	 */
	...
	public void execute(TransformerImpl transformer)
		...
		try {
			...
			if (transformer.getDebug()) {
				try {
					// flush any pending cached processing before sending the
					// trace event
