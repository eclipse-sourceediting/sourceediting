 ...
 */
/*
 * $Id: XalanTransformState.java,v 1.2 2008/03/28 02:38:16 dacarver Exp $
 */
...
public class XalanTransformState implements TransformState {
	...
	public Node getCurrentNode() {
		if (m_currentNode != null) {
			...
			DTM dtm = m_transformer.getXPathContext().getDTM(
					m_transformer.getCurrentNode());
	...
	public NodeIterator getContextNodeList() {
		if (m_elemPending) {
			...
			return new org.apache.xml.dtm.ref.DTMNodeIterator(m_transformer
					.getContextNodeList());
		}
	}
