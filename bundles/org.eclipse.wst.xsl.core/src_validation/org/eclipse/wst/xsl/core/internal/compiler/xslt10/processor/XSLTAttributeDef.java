...
public class XSLTAttributeDef
{
   ...
   */
  public XSLTAttributeDef(String namespace, String name, int type, boolean required, boolean supportsAVT, int errorType)
  {
   ...
   */
  public XSLTAttributeDef(String namespace, String name, int type, boolean supportsAVT, int errorType, String defaultVal)
  {
   ...
   * @param v2 An integer representation of k2.
    */
  public XSLTAttributeDef(String namespace, String name, boolean required, boolean supportsAVT, 
 ...
 /**
  ...
  public int m_errorType = this.WARNING;
   ...
   * @throws org.xml.sax.SAXException.
   */
  public Object processCDATA(StylesheetHandler handler, String uri, String name,
   ...
   */
  public Object processENUM(StylesheetHandler handler, String uri, String name,
                     String rawName, String value, ElemTemplateElement owner)
                     throws org.xml.sax.SAXException
  {
   ...
   *         is returned.
   */
  public Object processENUM_OR_PQNAME(StylesheetHandler handler, String uri, String name,
                     String rawName, String value, ElemTemplateElement owner)
                     throws org.xml.sax.SAXException
  {
   ...
   */
  public Object processNMTOKEN(StylesheetHandler handler, String uri, String name,
                        String rawName, String value, ElemTemplateElement owner)
             throws org.xml.sax.SAXException
  {
   ...
   * resolved, or the string contains syntax that is invalid for a qualified name.
   */
  public Object processAVT_QNAME(
          StylesheetHandler handler, String uri, String name, String rawName, String value, ElemTemplateElement owner)
            throws org.xml.sax.SAXException
  {
 ...
 /**
   ...
   */
  public Vector processSIMPLEPATTERNLIST(
          StylesheetHandler handler, String uri, String name, String rawName, String value,
          ElemTemplateElement owner)
            throws org.xml.sax.SAXException
  {
   ...
   */
  public StringVector processSTRINGLIST(StylesheetHandler handler, String uri,
                                 String name, String rawName, String value)
  {
   ...
   */
  public StringVector processPREFIX_URLLIST(
          StylesheetHandler handler, String uri, String name, String rawName, String value)
            throws org.xml.sax.SAXException
  {
  ...
  /**
    ...
    * @throws org.xml.sax.SAXException if one of the prefixes can not be resolved.
    */
   public StringVector processPREFIX_LIST(
   ...
   */
  public void setDefAttrValue(StylesheetHandler handler, ElemTemplateElement elem)
          throws org.xml.sax.SAXException
  {
