 ...
 */
/*
 * $Id: XSLTAttributeDef.java,v 1.3 2008/03/28 02:38:16 dacarver Exp $
 */
...
import org.eclipse.wst.xsl.core.internal.compiler.xslt10.templates.AVT;
...
public class XSLTAttributeDef {
	 ...
	 *            T_NUMBER, T_YESNO, T_QNAME, T_QNAMES, T_ENUM,
	 *            T_SIMPLEPATTERNLIST, T_NMTOKEN, T_STRINGLIST,
	 *            T_PREFIX_URLLIST, T_ENUM_OR_PQNAME, T_NCNAME.
	 * @param required
	 *            true if this is attribute is required by the XSLT
	 *            specification.
	 * @param supportsAVT
	 ...
	 *            ERROR, WARNING.
	 */
	public XSLTAttributeDef(String namespace, String name, int type,
			boolean required, boolean supportsAVT, int errorType) {
	 ...
	 */
	public XSLTAttributeDef(String namespace, String name, int type,
			boolean supportsAVT, int errorType, String defaultVal) {
	...
	/**
	 * Construct an instance of XSLTAttributeDef that uses two enumerated
	 * values.
	 * 
	 * @param namespace
	 *            The Namespace URI, or an empty string.
	 ...
	 */
	public XSLTAttributeDef(String namespace, String name, boolean required,
			boolean supportsAVT, boolean prefixedQNameValAllowed,
			int errorType, String k1, int v1, String k2, int v2) {

		this.m_namespace = namespace;
		this.m_name = name;
		this.m_type = prefixedQNameValAllowed ? XSLTAttributeDef.T_ENUM_OR_PQNAME
				: XSLTAttributeDef.T_ENUM;
		this.m_required = required;
		this.m_supportsAVT = supportsAVT;
		this.m_errorType = errorType;
	...
	public XSLTAttributeDef(String namespace, String name, boolean required,
			boolean supportsAVT, boolean prefixedQNameValAllowed,
			int errorType, String k1, int v1, String k2, int v2, String k3,
			int v3) {
	...
	public static final int T_CDATA = 1,
	...
	// <!-- Used for the type of an attribute value that is a URI reference.-->
			...
			// <!-- Used for the type of an attribute value that is a
			// pattern.-->
			T_PATTERN = 4,
	...
	public static final XSLTAttributeDef m_foreignAttr = new XSLTAttributeDef(
	 ...
	 * attributes set.
	 */
	public static final String S_FOREIGNATTR_SETTER = "setForeignAttr";
	...
	public int m_errorType = XSLTAttributeDef.WARNING;
	 ...
	 */
	private String m_setterString = null;

	/**
	 * Return a string that should represent the setter method. The setter
	 * method name will be created algorithmically the first time this method is
	...
	public String getSetterMethodName() {
		...
		if (null == m_setterString) {
			...
			if ((m_namespace != null)
					&& m_namespace
							.equals(org.apache.xml.utils.Constants.S_XMLNAMESPACEURI)) {
				outBuf.append("Xml");
			}
	 ...
	 *             which will wrap a
	 *             {@link javax.xml.transform.TransformerException}, if there
	 *             is a syntax error in the attribute value template string.
	 */
	public AVT processAVT(StylesheetHandler handler, String uri, String name,
	 ...
	 * @throws org.xml.sax.SAXException.
	 */
	public Object processCDATA(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		if (getSupportsAVT()) {
			try {
				AVT avt = new AVT(handler, uri, name, rawName, value, owner);
	 ...
	 */
	public Object processCHAR(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		if (getSupportsAVT()) {
			try {
	 ...
	 *         attribute does not support AVT. Otherwise, and AVT is returned.
	 */
	public Object processENUM(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		if (retVal == StringToIntTable.INVALID_KEY) {
			...
			handleError(handler, XSLTErrorResources.INVALID_ENUM, new Object[] {
					name, value, enumNamesList.toString() }, null);
			return null;
		}
	 ...
	 */
	public Object processENUM_OR_PQNAME(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		// enum not used. Validate qname-but-not-ncname.
			...
			try {
				...
				if (qname.getPrefix() == null) {
					...
					handleError(handler, XSLTErrorResources.INVALID_ENUM,
							new Object[] { name, value,
									enumNamesList.toString() }, null);
					return null;
				...
				handleError(handler, XSLTErrorResources.INVALID_ENUM,
						new Object[] { name, value, enumNamesList.toString() },
						ie);
				return null;
	 ...
	 */
	public Object processEXPR(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
	 ...
	 */
	public Object processNMTOKEN(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		if (getSupportsAVT()) {
			try {
				...
				if ((avt.isSimple()) && (!XML11Char.isXML11ValidNmtoken(value))) {
					handleError(handler, XSLTErrorResources.INVALID_NMTOKEN,
							new Object[] { name, value }, null);
					return null;
				}
				return avt;
	 ...
	 */
	public Object processPATTERN(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
	 ...
	 */
	public Object processNUMBER(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		if (getSupportsAVT()) {
			...
			try {
				...
				handleError(handler, XSLTErrorResources.INVALID_NUMBER,
						new Object[] { name, value }, nfe);
				return null;
			}
			return avt;
	 ...
	 * 
	 * @throws org.xml.sax.SAXException
	 *             if the string contains a prefix that can not be resolved, or
	 *             the string contains syntax that is invalid for a qualified
	 *             name.
	 */
	public Object processQNAME(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		try {
			...
			handleError(handler, XSLTErrorResources.INVALID_QNAME,
					new Object[] { name, value }, ie);
			return null;
		} catch (RuntimeException re) {
			// thrown by QName constructor
			handleError(handler, XSLTErrorResources.INVALID_QNAME,
					new Object[] { name, value }, re);
			return null;
		}
	}
	 ...
	 *             name.
	 */
	public Object processAVT_QNAME(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		try {
			...
			if (avt.isSimple()) {
				...
				String localName = (indexOfNSSep < 0) ? value : value
						.substring(indexOfNSSep + 1);
	 ...
	 * @throws org.xml.sax.SAXException
	 *             if the string contains a prefix that can not be resolved, or
	 *             the string contains syntax that is invalid for a NCName.
	 */
	public Object processNCNAME(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		if (getSupportsAVT()) {
			...
			try {
				...
				if ((avt.isSimple()) && (!XML11Char.isXML11ValidNCName(value))) {
					handleError(handler, XSLTErrorResources.INVALID_NCNAME,
							new Object[] { name, value }, null);
					return null;
				}
				return avt;
	 ...
	 * where the specification requires that non-prefixed elements not be placed
	 * in a namespace. (See section 2.4 of XSLT 1.0.)
	 * 
	 * @param handler
	 *            non-null reference to current StylesheetHandler that is
	 *            constructing the Templates.
	 ...
	 * 
	 * @throws org.xml.sax.SAXException
	 *             if the one of the qualified name strings contains a prefix
	 *             that can not be resolved, or a qualified name contains syntax
	 *             that is invalid for a qualified name.
	 */
	public Vector processQNAMES(StylesheetHandler handler, String uri,
	 ...
	 *             that is invalid for a qualified name.
	 */
	public Vector processQNAMESRNU(StylesheetHandler handler, String uri,
			String name, String rawName, String value)
			throws org.xml.sax.SAXException {
	 ...
	 */
	public Vector processSIMPLEPATTERNLIST(StylesheetHandler handler,
			String uri, String name, String rawName, String value,
		...
		try {
			...
			for (int i = 0; i < nPatterns; i++) {
				XPath pattern = handler.createMatchPatternXPath(tokenizer
						.nextToken(), owner);
	 ...
	 */
	public StringVector processSTRINGLIST(StylesheetHandler handler,
			String uri, String name, String rawName, String value) {
	 ...
	 */
	public StringVector processPREFIX_URLLIST(StylesheetHandler handler,
			String uri, String name, String rawName, String value)
			throws org.xml.sax.SAXException {
	...
	/**
	 * Process an attribute string of type T_PREFIXLIST into a vector of
	 * prefixes that may be resolved to URLs.
	 * 
	 * @param handler
	 *            non-null reference to current StylesheetHandler that is
	 *            constructing the Templates.
	 ...
	 *             if one of the prefixes can not be resolved.
	 */
	public StringVector processPREFIX_LIST(StylesheetHandler handler,
			String uri, String name, String rawName, String value)
			throws org.xml.sax.SAXException {
	 ...
	 */
	public Object processURL(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
	 ...
	 * @throws org.xml.sax.SAXException
	 */
	private Boolean processYESNO(StylesheetHandler handler, String uri,
			String name, String rawName, String value)
			throws org.xml.sax.SAXException {

		// Is this already checked somewhere else? -sb
		if (!(value.equals("yes") || value.equals("no"))) {
			handleError(handler, XSLTErrorResources.INVALID_BOOLEAN,
					new Object[] { name, value }, null);
			return null;
		}
	 ...
	 */
	public Object processValue(StylesheetHandler handler, String uri,
			String name, String rawName, String value, ElemTemplateElement owner)
			throws org.xml.sax.SAXException {
		...
		case T_QNAMES_RESOLVE_NULL:
			processedValue = processQNAMESRNU(handler, uri, name, rawName,
					value);
			break;
		case T_SIMPLEPATTERNLIST:
			processedValue = processSIMPLEPATTERNLIST(handler, uri, name,
					rawName, value, owner);
			break;
		case T_URL:
		...
		case T_YESNO:
			...
			break;
		case T_STRINGLIST:
			processedValue = processSTRINGLIST(handler, uri, name, rawName,
					value);
			break;
	 ...
	 */
	public void setDefAttrValue(StylesheetHandler handler,
			ElemTemplateElement elem) throws org.xml.sax.SAXException {
		setAttrValue(handler, this.getNamespace(), this.getName(), this
				.getName(), this.getDefault(), elem);
	}
	 ...
	 * one of the 9 primative types, it will return the same class that was
	 * passed in.
	 * 
	 * @param obj
	 *            The object which will be resolved to a primative class object
	 *            if possible.
	 * 
	 ...
	 * type. Used to build error message.
	 */
	 ...
	 * @throws org.xml.sax.SAXException
	 */
	public boolean setAttrValue(StylesheetHandler handler, String attrUri,
			String attrLocalName, String attrRawName, String attrValue,
			ElemTemplateElement elem) throws org.xml.sax.SAXException {
		...
		if (null != setterString) {
			try {
				...
				if (setterString.equals(S_FOREIGNATTR_SETTER)) {
					...
					Class[] argTypes = new Class[] { sclass, sclass, sclass,
							sclass };

					meth = elem.getClass().getMethod(setterString, argTypes);

					args = new Object[] { attrUri, attrLocalName, attrRawName,
							attrValue };
				} else {
					Object value = processValue(handler, attrUri,
							attrLocalName, attrRawName, attrValue, elem);
					// If a warning was issued because the value for this
					// attribute was
					...
					try {
						meth = elem.getClass()
								.getMethod(setterString, argTypes);
					} catch (NoSuchMethodException nsme) {
						Class cl = (value).getClass();

						// If this doesn't work, try it with the non-primative
						// value;
						argTypes[0] = cl;
						meth = elem.getClass()
								.getMethod(setterString, argTypes);
				...
				if (!setterString.equals(S_FOREIGNATTR_SETTER)) {
					handler.error(XSLTErrorResources.ER_FAILED_CALLING_METHOD,
							new Object[] { setterString }, nsme);// "Failed
																	// calling "
																	// +
																	// setterString
																	// + "
				...
				handler.error(XSLTErrorResources.ER_FAILED_CALLING_METHOD,
						new Object[] { setterString }, iae);// "Failed calling "
															// + setterString +
															// " method!", iae);
				return false;
				...
				handleError(handler,
						...
						new Object[] { Constants.ATTRNAME_NAME, getName() },
						nsme);
				return false;
			}
		}
	...
	private void handleError(StylesheetHandler handler, String msg,
			Object[] args, Exception exc) throws org.xml.sax.SAXException {
		switch (getErrorType()) {
		case (FATAL):
		case (ERROR):
