 ...
 */
/*
 * $Id: KeyRefIterator.java,v 1.2 2008/03/28 02:38:16 dacarver Exp $
 */
...
public class KeyRefIterator extends org.apache.xpath.axes.ChildTestIterator {
	 ...
	 */
	public KeyRefIterator(QName name, XMLString ref, Vector keyDecls,
			DTMIterator ki) {
		super(null);
		m_name = name;
		m_ref = ref;
	...
	protected DTMIterator m_keysNodes;
	...
	public short filterNode(int testNode) {
		...
		QName name = m_name;
		KeyIterator ki = (KeyIterator) (((XNodeSet) m_keysNodes)
				.getContainedIter());
		...
		try {
			...
			for (int i = 0; i < nDeclarations; i++) {
				...
				XObject xuse = kd.getUse().execute(xctxt, testNode,
