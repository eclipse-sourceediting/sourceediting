 ...
 */
/*
 * $Id: TransformerHandlerImpl.java,v 1.2 2008/03/28 02:38:16 dacarver Exp $
 */
 ...
 */
public class TransformerHandlerImpl implements EntityResolver, DTDHandler,
		ContentHandler, ErrorHandler, LexicalHandler, TransformerHandler,
		DeclHandler {
	/**
	...
	public void setResult(Result result) throws IllegalArgumentException {
		...
		try {
			...
			SerializationHandler xoh = m_transformer
					.createSerializationHandler(result);
			m_transformer.setSerializationHandler(xoh);
		} catch (javax.xml.transform.TransformerException te) {
			throw new IllegalArgumentException(XSLMessages.createMessage(
					XSLTErrorResources.ER_RESULT_COULD_NOT_BE_SET, null)); // "result
																			// could
																			// not
																			// be
																			// set");
	 ...
	 *             The client may throw an I/O-related exception while obtaining
	 *             the new InputSource.
	...
	public void unparsedEntityDecl(String name, String publicId,
		...
		if (m_dtdHandler != null) {
			m_dtdHandler.unparsedEntityDecl(name, publicId, systemId,
					notationName);
		}
	}
	...
	public void warning(SAXParseException e) throws SAXException {
		...
		javax.xml.transform.ErrorListener errorListener = m_transformer
				.getErrorListener();
		if (errorListener instanceof ErrorHandler) {
			...
			try {
				errorListener
						.warning(new javax.xml.transform.TransformerException(e));
			} catch (javax.xml.transform.TransformerException te) {
				throw e;
			}
		}
	...
	public void error(SAXParseException e) throws SAXException {
		...
		if (errorListener instanceof ErrorHandler) {
			...
			try {
				errorListener
						.error(new javax.xml.transform.TransformerException(e));
				if (null != m_errorHandler)
					m_errorHandler.error(e); // may not be called.
			} catch (javax.xml.transform.TransformerException te) {
				throw e;
	...
	public void fatalError(SAXParseException e) throws SAXException {
		...
		if (errorListener instanceof ErrorHandler) {
			...
			try {
				errorListener
						.fatalError(new javax.xml.transform.TransformerException(
								e));
				if (null != m_errorHandler)
					m_errorHandler.fatalError(e); // may not be called.
			} catch (javax.xml.transform.TransformerException te) {
	...
	public void attributeDecl(String eName, String aName, String type,
		...
		if (null != m_declHandler) {
			m_declHandler
					.attributeDecl(eName, aName, type, valueDefault, value);
		}
	}
	...
	public void internalEntityDecl(String name, String value)
		...
		if (DEBUG)
			System.out.println("TransformerHandlerImpl#internalEntityDecl: "
					+ name + ", " + value);
	...
	public void externalEntityDecl(String name, String publicId, String systemId)
		...
		if (DEBUG)
			System.out.println("TransformerHandlerImpl#externalEntityDecl: "
