...
/**
 * Provides basic tag information such as element/attribute name, data type, and tag info/documentation for CMNodes.
 * Uses HTML to enhance presentation.
 */
public class MarkupTagInfoProvider {
	 ...
	 * @param CMNode node - node to display information for
	 * 
	 * @return String
	 */
	...
	/**
	 * Adds the default info (element name, content model, data type)
	 * of CMNode to the string buffer, sb
	 * @param StringBuffer sb - string to place display info into
	 * @param CMNode node - node to get tag info from
	 */
	 ...
	 * @param StringBuffer sb - string to place display info into
	 * @param CMNode node - node to get tag description from
	 */
	 ...
	 * @param StringBuffer sb - string to place display info into
	 * @param CMNode node - node to get tag documentation from
	 */
	...
	/**
	 * Adds dataType's data type information, including enumerated type values to
	 * string buffer, sb
	 * @param StringBuffer sb - string to place data type info into
	 * @param CMDataType dataType - data type object to get info from (should not be null)
	 */
