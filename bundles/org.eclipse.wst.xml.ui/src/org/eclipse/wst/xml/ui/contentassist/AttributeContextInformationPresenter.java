...
/**
 * Responsible for the presentation of the context info popup. This includes text style,
 * and when the window should close.
 * 
 * @author pavery
 */
public class AttributeContextInformationPresenter implements IContextInformationPresenter, IContextInformationValidator {
	...
	public boolean isContextInformationValid(int documentPosition) {
		// determine whether or not this context info should still be showing...
