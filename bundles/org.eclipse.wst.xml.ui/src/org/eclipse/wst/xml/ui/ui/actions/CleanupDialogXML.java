...
public class CleanupDialogXML extends Dialog implements SelectionListener {
	...
	protected void initializeOptions() {
		...
		if (EOLCode.compareTo(CommonModelPreferenceNames.LF) == 0)
			fRadioButtonConvertEOLUnix.setSelection(true);
		else if (EOLCode.compareTo(CommonModelPreferenceNames.CR) == 0)
	...
	protected void storeOptions() {
		...
		if (fRadioButtonConvertEOLUnix.getSelection()) {
			getModelPreferences().setValue(CommonModelPreferenceNames.CLEANUP_EOL_CODE, CommonModelPreferenceNames.LF);
		}
		else if (fRadioButtonConvertEOLMac.getSelection()) {
			getModelPreferences().setValue(CommonModelPreferenceNames.CLEANUP_EOL_CODE, CommonModelPreferenceNames.CR);
		}
		else {
			getModelPreferences().setValue(CommonModelPreferenceNames.CLEANUP_EOL_CODE, CommonModelPreferenceNames.CRLF);
		}
