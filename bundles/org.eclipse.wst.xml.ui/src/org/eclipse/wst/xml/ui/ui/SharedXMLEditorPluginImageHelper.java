...
public class SharedXMLEditorPluginImageHelper {
	...
	/**
	 * Retrieves the specified image from the xml source editor plugin's image registry.
	 ...
	 * declared in this class for build-in images that come with the xml source editor
	...
	/**
	 * Retrieves the image descriptor for specified image from the xml source editor plugin's
	 * image registry. Unlike <code>Image</code>s, image descriptors themselves do
	 * not need to be disposed.
	 *
	 * @param symbolicName the symbolic name of the image; there are constants
	 * declared in this interface for build-in images that come with the xml source editor
