...
/**
 * some relevance constants for content assist
 * higher relevance means it shows up higher on the list
 */
public interface XMLRelevanceConstants extends IRelevanceConstants {

	// add this onto "required" attrs, elements, etc to bubble them up on sorting...
	// CMVC 246618
	int R_REQUIRED = 10;
