...
/**
 * A class that uses a JFaceNodeAdapterFactory to provide adapters
 * to provide the labels and images for DOM nodes.
 */
public class JFaceNodeLabelProvider implements ILabelProvider {
	...
	/**
	 * Adds a listener to the label provider. A label provider 
	 * should inform its listener about state changes that enforces 
	 * rendering of the visual part that uses this label provider.
	 */
	...
	/**
	 * The visual part that is using this label provider is about
	 ...
	 *	Element can be <code>null</code> indicating no input object
	 *  is set to the viewer.
	 */
	...
	public java.lang.String getText(Object element) {
		// This was returning null, on occasion ... probably should not be, but
	...
	/**
	 * Checks whether this label provider is affected by the
	 * given domain event.
	 */
