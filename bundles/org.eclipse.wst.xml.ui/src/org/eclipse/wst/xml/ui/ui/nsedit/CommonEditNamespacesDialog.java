...
import org.eclipse.wst.xml.ui.ui.dialogs.EditNamespaceInfoDialog;
import org.eclipse.wst.xml.ui.ui.dialogs.NamespaceInfoErrorHelper;
...
public class CommonEditNamespacesDialog {
	 ...
	 * Note: The GridData for the returned Composite has a heightHint = 0.  This means
	 * when using the returned Composite, the GridData must be reset, else the Composite
	 * and it's contents will not appear.
	 */
	...
	protected void createButtons(Composite parent) {
		...
		//newButton.setText("   " + XMLCommonUIPlugin.getInstance().getString("_UI_BUTTON_NEW") + "   ");
