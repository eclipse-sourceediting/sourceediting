...
import org.eclipse.wst.xml.ui.ui.dialogs.SelectFileOrXMLCatalogIdDialog;
...
public class CommonAddNamespacesControl extends Composite implements SelectionListener {
	...
	public CommonAddNamespacesControl(Composite parent, int style, IPath resourceLocation) {
		...
		//namespaceInfoGroup.setText("Namespace Declarations"); //XMLCommonUIPlugin.getInstance().getString("_UI_LABEL_XML_SCHEMA_INFORMATION"));
	...
	class EditNamespaceControl extends Composite {
		...
		public EditNamespaceControl(Composite parent) {
			...
			//prefixField.setEnabled(info.getProperty("prefix-readOnly") == null);
			...
			//locationHintField.setEnabled(info.getProperty("locationHint-readOnly") == null);
		...
		protected void performBrowse() {
			...
			if (dialog.getReturnCode() == Window.OK) {
				...
				try {
					//TODO				 CMDocument document = CMDocumentBuilderRegistry.getInstance().buildCMDocument(grammarURI);
