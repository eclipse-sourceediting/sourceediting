...
import org.eclipse.wst.xml.ui.ui.actions.AddBlockCommentActionXML;
import org.eclipse.wst.xml.ui.ui.actions.CleanupActionXML;
import org.eclipse.wst.xml.ui.ui.actions.RemoveBlockCommentActionXML;
import org.eclipse.wst.xml.ui.ui.actions.ToggleCommentActionXML;
...
public class StructuredTextEditorXML extends StructuredTextEditor {
	protected void createActions() {
		...
		/*
		 action = new CommentActionXML(resourceBundle, StructuredTextEditorActionConstants.ACTION_NAME_COMMENT + DOT, this);
		 action.setActionDefinitionId(ActionDefinitionIds.COMMENT);
		 setAction(StructuredTextEditorActionConstants.ACTION_NAME_COMMENT, action);

		 action = new UncommentActionXML(resourceBundle, StructuredTextEditorActionConstants.ACTION_NAME_UNCOMMENT + DOT, this);
		 action.setActionDefinitionId(ActionDefinitionIds.UNCOMMENT);
		 setAction(StructuredTextEditorActionConstants.ACTION_NAME_UNCOMMENT, action);
		 */
