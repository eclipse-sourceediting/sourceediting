 ...
 *  If the single-argument form of the function is used, then the value returned
 * for an empty sequence is the xs:integer value 0. If the two-argument form is
 * used, then the value returned for an empty sequence is the value of the $zero
 * argument.
 */
