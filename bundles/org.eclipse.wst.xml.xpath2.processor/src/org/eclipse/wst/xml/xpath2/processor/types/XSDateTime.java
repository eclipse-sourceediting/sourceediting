 ...
 */
public class XSDateTime extends CalendarType  implements CmpEq,
							 CmpLt,
							 CmpGt,
	 ...
	 * @param cal The Calendar representation of the date and time to be stored
	 ...
	 * @param str The String representation of the date (and optional timezone)
	 * @return Integer array of size 3. Element 1 is the year, element 2 is the month and element 3 is the day
	 */
	 ...
	 * @param str The String representation of the date (and optional timezone)
	 * @return Integer array of size 3. Element 1 is the hour, element 2 is the minute and element 3 is the seconds
	 */
	 ...
	 * @param str The String representation of the date (and optional timezone)
	 * @return Integer array of size 3. Element 1 represents whether the timezone is ahead or behind GMT,
	 * element 2 is the hour displacement and element 3 is the minute displacement.
	 */
	 ...
	 * @return True if successfully set. False otherwise (due to out of bounds for that field)
	 */
	 ...
	 * @param str The String representation of the date (and optional timezone)
	 * @return The XSDateTime representation of the date and time (and optional timezone)
	 */
	public static XSDateTime parseDateTime(String str) {
		...
		if(timezone != null) {
			...
			tzd = new XDTDayTimeDuration(0, tz[1], tz[2], 0.0,
						     tz[0] < 0);
	...
	/**
	  ...
	  * @param arg The result sequence from which to extract the date and time value.
	  * @throws DynamicError
	  * @return A new result sequence consisting of the date and time value supplied.
	  */
	@Override
	 ...
	 * @param num Number that si to be padded (if neccessay)
	 * @param len Desired length after padding
	...
	// comparisons
		 ...
		 * @param arg XSDateTime representation of the date to compare to
		 * @throws DynamicError
		 * @return True if the two dates and times are represent the same exact point in time. False otherwise.
		 */
        public boolean eq(AnyType arg) throws DynamicError {
                XSDateTime val = (XSDateTime)
                                 NumericType.get_single_type(arg,
                                                             XSDateTime.class);
		 ...
		 * @param arg XSDateTime representation of the date to compare to
		 * @throws DynamicError
		 * @return True if in time, this date and time lies before the date and time supplied. False otherwise.
		 */
		 ...
		 * @param arg XSDateTime representation of the date to compare to
		 * @throws DynamicError
		 * @return True if in time, this date and time lies after the date and time supplied. False otherwise.
		 */
     ...
     * Retrieves the date in milliseconds since the begining of epoch
	...
	// math
         ...
         * are only valid ones). 
         * @param arg The supplied ResultSequence that is on the right of the minus operator. If this is an XSDateTime, the result will be a 
         ...
         * @return New ResultSequence consisting of the result of the mathematical minus operation.
         */
		...
		try {
			if(at instanceof XSDateTime) {
	        	        XSDateTime val = (XSDateTime)
        	        	                 NumericType.get_single_type(arg, XSDateTime.class);
         ...
         * are only valid ones). 
         * @param arg The supplied ResultSequence that is on the right of the minus operator. If arg is an XDTYearMonthDuration or an XDTDayTimeDuration
         * the result will be a XSDateTime of the result of the current date minus the duration of time supplied.
         * @return New ResultSequence consisting of the result of the mathematical minus operation.
         */
