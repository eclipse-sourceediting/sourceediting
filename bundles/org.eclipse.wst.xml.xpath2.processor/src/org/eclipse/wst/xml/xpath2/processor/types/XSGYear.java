...
public class XSGYear extends CalendarType implements CmpEq {
	...
	/**
	 * Parses a String representation of a year and constructs a new
	 * XSGYear representation of it.
	 * @param str The String representation of the year (and optional timezone)
	...
	/**
	 * Creates a new ResultSequence consisting of the extractable gYear in the supplied 
	 * ResultSequence
	 * @param arg The ResultSequence from which the gYear is to be extracted
	...
	public Calendar calendar() {
		 ...
		 * must be of type XSGYear
		 * @param arg The XSGYear to compare with
		 * @return True if the two representations are of the same year. False otherwise
		 * @throws DynamicError
		 */
        public boolean eq(AnyType arg) throws DynamicError {
                XSGYear val = (XSGYear)
                             NumericType.get_single_type(arg, XSGYear.class);
