...
/**
 * <p>Function to calculate string length.</p>
 *
 * <p>Usage: fn:string-length($arg as xs:string?) as xs:integer</p>
 *
 * <p>This class returns an xs:integer equal to the length in characters of the value of $arg.</p>
 *
 * <p>If the value of $arg is the empty sequence, the xs:integer 0 is returned.</p>
 */
public class FnStringLength extends Function {
	 ...
	 * @param args are used to obtain the string length.
	 * @throws DynamicError Dynamic error.
	 * @return The result of obtaining the string length from the arguments.
	 */
	public static ResultSequence string_length(Collection args) throws DynamicError {
