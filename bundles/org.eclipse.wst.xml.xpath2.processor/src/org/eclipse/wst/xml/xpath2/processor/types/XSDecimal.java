...
public class XSDecimal extends NumericType {
	...
	public boolean zero() {
	  ...
	  * @param arg The result sequence from which to extract the decimal number.
	  * @throws DynamicError
	 ...
	 */
	public double double_value() { return _value; }
	/**
	 * Sets the number stored to that supplied
	 * @param x Number to be stored
	 */
	public void set_double(double x) { _value = x; }

	// comparisons
	/**
	 * Equality comparison between this number and the supplied representation. Currently no numeric type promotion exists so the supplied 
	 * representation must be of type XSDecimal.
	 * @param at Representation to be compared with (must currently be of type XSDecimal)
	 * @return True if the 2 representation represent the same number. False otherwise
	 */
	public boolean eq(AnyType at) throws DynamicError {
		...
		/**
		 * Comparison between this number and the supplied representation. Currently no numeric type promotion exists so the supplied 
		 * representation must be of type XSDecimal.
		 * @param arg Representation to be compared with (must currently be of type XSDecimal)
		 * @return True if the supplied type represents a number smaller than this one stored. False otherwise
		 */
		 ...
		 * representation must be of type XSDecimal.
		 * @param arg Representation to be compared with (must currently be of type XSDecimal)
		 * @return True if the supplied type represents a number greater than this one stored. False otherwise
		 */
	...
	// math
	/**
	 * Mathematical addition operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDecimal.
	 * @param arg The ResultSequence to perform an addition with
	 * @return A XSDecimal consisting of the result of the mathematical addition.
	 */
	public ResultSequence plus(ResultSequence arg) throws DynamicError {
		...
		// own it
		return ResultSequenceFactory.create_new(new XSDecimal(double_value() + dt.double_value()));
	}
	/**
	 * Mathematical subtraction operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDecimal.
	 * @param arg The ResultSequence to perform a subtraction with
	 * @return A XSDecimal consisting of the result of the mathematical subtraction.
	 */
	public ResultSequence minus(ResultSequence arg) throws DynamicError {
		...
		/**
		 * Mathematical multiplication operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSDecimal.
	  	 * @param arg The ResultSequence to perform a multiplication with
		 * @return A XSDecimal consisting of the result of the mathematical multiplication.
		 */
        public ResultSequence times(ResultSequence arg) throws DynamicError {
                XSDecimal val = (XSDecimal) get_single_type(arg, XSDecimal.class);
                return ResultSequenceFactory.create_new(new XSDecimal(double_value() * val.double_value()));
        }
		/**
		 * Mathematical division operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSDecimal.
	  	 * @param arg The ResultSequence to perform a division with
		 * @return A XSDecimal consisting of the result of the mathematical division.
		 */
        ...
        /**
		 * Mathematical integer division operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSDecimal.
	  	 * @param arg The ResultSequence to perform an integer division with
		 * @return A XSInteger consisting of the result of the mathematical integer division.
		 */
        ...
        /**
		 * Mathematical modulus operator between this XSDecimal and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSDecimal.
