...
public class XSGYearMonth extends CalendarType implements CmpEq {
	 ...
	 * @param cal Calendar representation of the year and month to be stored
	 * @param tz Timezone associated with this year and month
	 */
	 ...
	 * @param str The String representation of the year and month (and optional timezone)
	...
	/**
	 * Creates a new ResultSequence consisting of the extractable gYearMonth in the supplied 
	 * ResultSequence
	 * @param arg The ResultSequence from which the gYearMonth is to be extracted
	...
	public Calendar calendar() {
		 ...
		 * must be of type XSGYearMonth
		 * @param arg The XSGYearMonth to compare with
		 * @return True if the two representations are of the same year and month. False otherwise
		 * @throws DynamicError
		 */
        public boolean eq(AnyType arg) throws DynamicError {
                XSGYearMonth val = (XSGYearMonth)
                             NumericType.get_single_type(arg, XSGYearMonth.class);
