...
public interface DynamicContext extends StaticContext {
	...
	/**
	 * Set variable.
 	 * @param var is name of the variable.
	 * @param val is the value to be set for the variable.
 	 */
	...
	public ResultSequence evaluate_function(QName name, 
						Collection args) throws DynamicError;
	...
	/**
	 * Get document.
	 * @param uri is the URI of the document.
 	 * @return document.
 	 */
	// available doc
	...
	/**
	 * Set focus.
 	 * @param focus is focus to be set. 
 	 */
	// Other functions
