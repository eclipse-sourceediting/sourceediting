 ...
 * converted to an xs:double, the xs:double value NaN is returned. If the context item
...
public class FnNumber extends Function {
	 ...
	 * @param dc Result of dynamic context operation.
         ...
         */
	public static ResultSequence fn_number(ResultSequence arg, DynamicContext dc) throws DynamicError {
