...
public class StaticNameResolver implements XPathVisitor, StaticChecker {
	 ...
	 * @param sc is the static context.
	 */
	 ...
	 * @param node is the XPath node to check.
	 * @throws StaticError static error. 
	 */
	 ...
	 * @param name is the name of the binary expression. 
	 * @param e is the expression itself. 
	 */
	 ...
	 * @param name is the name of the expression.
	 * @param e is the expression itself.
	 */
	...
	public Object visit(VarRef e) {
		...
		if(!_sc.variable_in_scope(var)) 
			report_error(new StaticVarNameError(
	...
	public Object visit(FunctionCall e) {
		...
		if(!_sc.function_exists(name,e.arity()))
			report_error(new StaticFunctNameError(
			 "Function does not exist: " + name.string() + 
			 " arity: " + e.arity()));
		...
		switch(e.type()) {
			...
			case ItemType.QNAME:
				...
				if(!_sc.type_defined(e.qname()))
					report_error(new StaticTypeNameError(
							  "Type not defined: " +
					        	  e.qname().string()));
				break;
	...
	public Object visit(SchemaAttrTest e) {
		...
		if(!_sc.attribute_declared(name))
			report_error(new StaticAttrNameError(
					  "Attribute not decleared: " +
					  name.string()));
	...
	public Object visit(SchemaElemTest e) {
		...
		if(!_sc.element_declared(elem))
			report_error(new StaticElemNameError(
