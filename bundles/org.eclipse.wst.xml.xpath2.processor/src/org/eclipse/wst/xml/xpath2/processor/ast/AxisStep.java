 ...
 * These nodes are always returned in Document Order. This can be
 * Forward Step or Reverse Step.
 */
public class AxisStep extends StepExpr {
	 ...
	 * @param step Defines forward/reverse step.
	 * @param exprs Collection of xpath expressions.
	 */
	 ...
	 */
	public Step step() { return _step; }
	/**
	 * Set the step direction.
	 */
	public void set_step(Step s) { _step = s; }
	/**
	 * Interator.
	 ...
	 */
	public int predicate_count() { return _exprs.size(); }
}
