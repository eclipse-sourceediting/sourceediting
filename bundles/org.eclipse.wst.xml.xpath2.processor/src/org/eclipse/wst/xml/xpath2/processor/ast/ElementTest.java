...
public class ElementTest extends AttrElemTest {
	 ...
	 * This takes in 4 inputs, Name, wildcard test(true/false), type and question mark
	 * test(true/false).
	 * @param name Name of element to test.
	 * @param wild Wildcard test? (true/false).
	 * @param type Type of element to test.
	 * @param qmark Nilled property (true/false).
	 */
	public ElementTest(QName name, boolean wild, QName type, boolean qmark) {
        ...
        /**
         * Constructor for ElementTest.
         * This takes in 3 inputs, Name, wildcard test(true/false)and type.
         * @param name Name of element to test.
         * @param wild Wildcard test? (true/false).
         * @param type Type of element to test.
         */
	public ElementTest(QName name, boolean wild, QName type ) {
        ...
        /**
         * Constructor for ElementTest.
         * This takes in 2 inputs, Name, wildcard test(true/false).
         * @param name Name of element to test.
         * @param wild Wildcard test? (true/false).
         */
