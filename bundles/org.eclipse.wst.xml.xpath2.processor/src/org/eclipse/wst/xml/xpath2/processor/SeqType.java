...
public class SeqType {
	 ...
	 * sequence type
	 * @param t is any type
	 * @param occ is an integer in the sequence.
 	 */
	...
	/**
	 * @param st is a sequence type.
	 * @param sc is a static context.
 	 */
	// XXX hack 2
	 ...
	 * @return an integer.
 	 */
	public int occurence() { return _occ; }

	/**
	 * @return a type.
 	 */
	public AnyType type() { return _type; }

	/**
	 * matches args
	 * @param args is a result sequence
