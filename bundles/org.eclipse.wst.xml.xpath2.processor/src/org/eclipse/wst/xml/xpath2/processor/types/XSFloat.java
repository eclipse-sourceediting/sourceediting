...
public class XSFloat extends NumericType {
	 ...
	 * @param x The number to be stored
	 */
	...
	public boolean zero() {
		...
		/**
		 * Creates a new ResultSequence consisting of the retrievable float in the supplied 
		 * ResultSequence
		 * @param arg The ResultSequence from which to extract the float
     ...
     */    
	public float float_value() { return _value; }
	/**
	 * Equality comparison between this number and the supplied representation. Currently
	 * no numeric type promotion exists so this representation must be of type XSFloat
	 * @param aa The datatype to compare with
	 * @return True if the two representations are of the same number. False otherwise
	 * @throws DynamicError
	 */
	public boolean eq(AnyType aa) throws DynamicError {
		 ...
		 * no numeric type promotion is implemented so this representation must be of 
		 * type XSFloat
		 * @param arg The datatype to compare with
		 * @return True if the supplied representation is a smaller number than the one
		 ...
		 * type XSFloat
		 * @param arg The datatype to compare with
		 * @return True if the supplied representation is a greater number than the one
		 * stored. False otherwise
		 * @throws DynamicError
		 */
    ...
    /**
	 * Mathematical addition operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSFloat.
	...
	/**
	 * Mathematical subtraction operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSFloat.
	 * @param arg The ResultSequence to perform a subtraction with
	 * @return A XSFloat consisting of the result of the mathematical subtraction.
	 */
	public ResultSequence minus(ResultSequence arg) throws DynamicError {
		...
		/**
		 * Mathematical multiplication operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSFloat.
		 * @param arg The ResultSequence to perform a multiplication with
		 * @return A XSFloat consisting of the result of the mathematical multiplication.
		 */
        ...
        /**
		 * Mathematical division operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSFloat.
        ...
        /**
		 * Mathematical integer division operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSFloat.
        ...
        public ResultSequence idiv(ResultSequence arg) throws DynamicError {
                ...
                return ResultSequenceFactory.create_new(new XSInteger((int) (float_value() / val.float_value()) ));
        }
        /**
		 * Mathematical modulus operator between this XSFloat and the supplied ResultSequence. Due to no numeric type promotion or
		 * conversion, the ResultSequence must be of type XSFloat.
