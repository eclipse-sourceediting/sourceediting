...
public abstract class BinExpr extends Expr {
	 ...
	 * @return Left node.
	 */
	public XPathNode left() { return _left; }
	/**
	 * Right xpath node.
	 * @return Right node.
	 */
	public XPathNode right() { return _right; }

	/**
	 * Set the left xpath node.
	 * @param n Left node.
	 */
	public void set_left(XPathNode n) { _left = n; }
	/**
	 * Set the right xpath node.
	 * @param n Right node.
	 */
	public void set_right(XPathNode n) { _right = n; }
}
