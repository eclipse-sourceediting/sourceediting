...
public class XSDouble extends NumericType {
	 ...
	 * @param init String representation of the number to be stored
	 */
	 ...
	 * @param i String representation of the number to be stored
	...
	public static XSDouble parse_double(String i) {
		 ...
		 * @param arg The result sequence from which to extract the double number.
		 * @throws DynamicError
	 ...
	 * representation must be of type XSDouble.
	 * @param aa Representation to be compared with (must currently be of type XSDouble)
	 * @return True if the 2 representations represent the same number. False otherwise
	 */
	 ...
	 * representation must be of type XSDouble.
	 * @param arg Representation to be compared with (must currently be of type XSDouble)
	...
	// math
	/**
	 * Mathematical addition operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
    ...
    /**
	 * Mathematical subtraction operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
	 * @param arg The ResultSequence to perform an subtraction with
	 * @return A XSDouble consisting of the result of the mathematical subtraction.
	 */
    ...
    /**
	 * Mathematical multiplication operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
	 * @param arg The ResultSequence to perform an multiplication with
	 * @return A XSDouble consisting of the result of the mathematical multiplication.
	 */
    ...
    /**
	 * Mathematical division operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
	 * @param arg The ResultSequence to perform an division with
    ...
    /**
	 * Mathematical integer division operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
    ...
    /**
	 * Mathematical modulus operator between this XSDouble and the supplied ResultSequence. Due to no numeric type promotion or
	 * conversion, the ResultSequence must be of type XSDouble.
