 ...
 */
public class XSDate extends CalendarType implements CmpEq,
 						    CmpLt,
						    CmpGt,
	 ...
	 * @param cal The Calendar representation of the date to be stored
	...
	/**
	 * Parses a String representation of a date (of the form year-month-day or year-month-day+timezone) and constructs a new
	 * XSDate representation of it.
	...
	public static XSDate parse_date(String str) {
	  ...
	  * @param arg The result sequence from which to extract the date value.
	  * @throws DynamicError
	 ...
	 * @return True if there is a timezone associated with this date. False otherwise.
	 */
	...
	// comparisons
		 ...
		 * @param arg XSDate representation of the date to compare to
		 * @throws DynamicError
		 * @return True if the two dates are represent the same exact point in time. False otherwise.
		 */
        public boolean eq(AnyType arg) throws DynamicError {
                XSDate val = (XSDate)
                             NumericType.get_single_type(arg, XSDate.class);
		 ...
		 * @param arg XSDate representation of the date to compare to
		 * @throws DynamicError
		 * @return True if in time, this date lies before the date supplied. False otherwise.
		 */
		 ...
		 * @param arg XSDate representation of the date to compare to
		 * @throws DynamicError
		 * @return True if in time, this date lies after the date supplied. False otherwise.
		 */
         ...
         * are only valid ones). 
         * @param arg The supplied ResultSequence that is on the right of the minus operator. If this is an XSDate, the result will be a 
		...
		/**
         * Mathematical addition operator between this XSDate and a supplied result sequence (XDTYearMonthDuration and XDTDayTimeDuration
         * are only valid ones). 
