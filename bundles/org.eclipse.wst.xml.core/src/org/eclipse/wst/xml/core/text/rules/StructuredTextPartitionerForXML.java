...
public class StructuredTextPartitionerForXML extends StructuredTextPartitioner implements IStructuredTextPartitioner {
	public final static String ST_DEFAULT_XML = "org.eclipse.wst.sse.DEFAULT_XML"; //$NON-NLS-1$
	public final static String ST_XML_CDATA = "org.eclipse.wst.sse.XML_CDATA"; //$NON-NLS-1$
	public final static String ST_XML_PI = "org.eclipse.wst.sse.XML_PI"; //$NON-NLS-1$
	public final static String ST_XML_DECLARATION = "org.eclipse.wst.sse.XML_DECL"; //$NON-NLS-1$
	public final static String ST_XML_COMMENT = "org.eclipse.wst.sse.XML_COMMENT"; //$NON-NLS-1$

	/**
	 * Should match org.eclipse.wst.dtd.core.partitioning.StructuredTextPartitionerForDTD.ST_DTD_SUBSET
	 */
	public static final String ST_DTD_SUBSET = "org.eclipse.wst.dtd.internal_subset"; //$NON-NLS-1$
	...
	protected String getPartitionFromBlockedText(ITextRegion region, int offset, String result) {
		...
		// nsd_TODO: David and I need to discuss, design, and implement this for all block tags and comments
	...
	protected boolean doParserSpecificCheck(int offset, boolean partitionFound, IStructuredDocumentRegion sdRegion, IStructuredDocumentRegion previousStructuredDocumentRegion, ITextRegion next, ITextRegion previousStart) {
		...
		// for quick fix to transition problems. Heirarchy needs lots of cleanup.
