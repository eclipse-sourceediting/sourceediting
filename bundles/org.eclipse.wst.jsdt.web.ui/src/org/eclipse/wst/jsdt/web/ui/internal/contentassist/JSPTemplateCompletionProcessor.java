 ...
 * JSPTemplateCompletionProcessor is asked for content assist proposals, the jsp
...
class JSPTemplateCompletionProcessor extends TemplateCompletionProcessor {
	...
	protected Image getImage(Template template) {
		...
		return JSPEditorPluginImageHelper.getInstance().getImage(
				JSPEditorPluginImages.IMG_OBJ_TAG_JSP);
	}
