...
import org.eclipse.jsdt.ui.text.java.CompletionProposalCollector;
import org.eclipse.jsdt.ui.text.java.CompletionProposalComparator;
...
public class JSPProposalCollector extends CompletionProposalCollector {
	...
	public JSPCompletionProposal[] getJSPCompletionProposals() {
		...
		return (JSPCompletionProposal[]) results
				.toArray(new JSPCompletionProposal[results.size()]);
	}
