...
import org.eclipse.wst.jsdt.web.core.internal.contentmodel.tld.CMDocumentImpl;

import org.eclipse.wst.jsdt.web.core.internal.contentmodel.tld.TaglibTracker;
import org.eclipse.wst.jsdt.web.core.internal.contentmodel.tld.provisional.TLDFunction;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.ASTExpression;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.ASTFunctionInvocation;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.FindFunctionInvocationVisitor;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.JSPELParser;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.JSPELParserConstants;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.JSPELParserTokenManager;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.ParseException;
import org.eclipse.wst.jsdt.web.core.internal.java.jspel.SimpleCharStream;
...
public class JSPELContentAssistProcessor extends JSPJavaContentAssistProcessor {
	...
	public ICompletionProposal[] computeCompletionProposals(ITextViewer viewer,
		...
		ICompletionProposal[] results = fJspCompletionProcessor
				.computeCompletionProposals(viewer, documentPosition);
		fErrorMessage = fJspCompletionProcessor.getErrorMessage();
		if (results.length == 0
				&& (fErrorMessage == null || fErrorMessage.length() == 0)) {
		...
		if (flat != null) {
			...
			if (DOMRegionContext.XML_TAG_ATTRIBUTE_VALUE == cursorRegion
					.getType()) {
				...
				if (cursorRegion.getType() == DOMJSPRegionContexts.JSP_EL_CONTENT) {
					...
					String prefix = getPrefix(documentPosition
							- container.getStartOffset(cursorRegion) - 1,
							elText);
					if (null != prefix) {
	...
	protected String getPrefix(int relativePosition, String elText) {
		System.out
				.println("Unimplemented JSPELContentAssistProcess.getPrefix ");
	...
	protected ASTFunctionInvocation getInvocation(int relativePosition,
			String elText) {
		System.out
				.println("Unimplemented JSPELContentAssistProcess.getInvocation ");
		FindFunctionInvocationVisitor visitor = new FindFunctionInvocationVisitor(
				relativePosition);
	...
	protected List getFunctionProposals(String prefix,
			StructuredTextViewer viewer, int offset) {
		System.out
				.println("Unimplemented JSPELContentAssistProcess.getFunctionProposals() ");
