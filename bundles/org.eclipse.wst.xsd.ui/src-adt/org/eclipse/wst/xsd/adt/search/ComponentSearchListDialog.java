...
public class ComponentSearchListDialog extends Dialog {
    ...
    protected SelectionListener newButtonSelectionListener;
    ...
    public void setNewButtonSelectionListener(SelectionListener newButtonSelectionListener)
    {
      this.newButtonSelectionListener = newButtonSelectionListener;
    }
    ...
    public Control createDialogArea(Composite parent) {
        ...
        if (newButtonSelectionListener != null )
        {  
        ...
        componentTableViewer.getTable().addSelectionListener(new SelectionListener(){
        	...
        	IComponentDescriptionProvider lp = (IComponentDescriptionProvider) 
			configuration.getDescriptionProvider().getLabelProvider();        	
    ...
    private void updateLocationView(IFile file) {
        ...
        locationLabel.setImage(XSDEditorPlugin.getXSDImage("icons/XSDFile.gif"));
        //locationView.redraw();
    }
