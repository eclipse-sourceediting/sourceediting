 ...
 *
 * $Id: DataTypesFactoryImpl.java,v 1.3 2008/08/30 03:41:11 dacarver Exp $
 */
...
public class DataTypesFactoryImpl extends EFactoryImpl implements DataTypesFactory {
	...
	public static DataTypesFactory init() {
		try {
			DataTypesFactory theDataTypesFactory = (DataTypesFactory)EPackage.Registry.INSTANCE.getEFactory("org.eclipse.wst.xml.xpath.core.internal.model.datatypes"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DataTypesPackage.VARIABLE: return createVariable();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DataTypesPackage.DATA_TYPES:
