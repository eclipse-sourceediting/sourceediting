 ...
 *
 * $Id: FunctionFactoryImpl.java,v 1.3 2008/08/30 03:41:10 dacarver Exp $
 */
...
public class FunctionFactoryImpl extends EFactoryImpl implements FunctionFactory {
	...
	public static FunctionFactory init() {
		try {
			FunctionFactory theFunctionFactory = (FunctionFactory)EPackage.Registry.INSTANCE.getEFactory("org.eclipse.wst.xml.xpath.core.internal.model.functions"); 
