 ...
 *
 * $Id: AxisSwitch.java,v 1.3 2008/08/30 03:41:10 dacarver Exp $
 */
...
public class AxisSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AxisPackage.AXIS: {
				Axis axis = (Axis)theEObject;
				T result = caseAxis(axis);
				if (result == null) result = caseXpathCommon(axis);
				if (result == null) result = caseComponent(axis);
