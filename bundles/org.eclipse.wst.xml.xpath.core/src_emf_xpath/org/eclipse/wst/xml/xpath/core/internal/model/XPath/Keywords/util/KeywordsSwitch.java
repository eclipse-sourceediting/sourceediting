 ...
 *
 * $Id: KeywordsSwitch.java,v 1.1 2008/04/22 21:07:28 dacarver Exp $
 */
...
public class KeywordsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KeywordsPackage.KEYWORD: {
				Keyword keyword = (Keyword)theEObject;
				T result = caseKeyword(keyword);
				if (result == null) result = caseXpathCommon(keyword);
				if (result == null) result = caseComponent(keyword);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Xpath Common</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Xpath Common</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXpathCommon(XpathCommon object) {
		return null;
	}
