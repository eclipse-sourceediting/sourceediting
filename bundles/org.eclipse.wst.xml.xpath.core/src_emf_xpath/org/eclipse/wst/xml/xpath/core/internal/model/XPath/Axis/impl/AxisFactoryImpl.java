 ...
 *
 * $Id: AxisFactoryImpl.java,v 1.3 2008/08/30 03:41:05 dacarver Exp $
 */
...
public class AxisFactoryImpl extends EFactoryImpl implements AxisFactory {
	...
	public static AxisFactory init() {
		try {
			AxisFactory theAxisFactory = (AxisFactory)EPackage.Registry.INSTANCE.getEFactory("org.eclipse.wst.xml.xpath.core.internal.model.axis"); 
